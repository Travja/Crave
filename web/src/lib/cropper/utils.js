export function Utils(errorOutputId) { // eslint-disable-line no-unused-vars
    ...
    const OPENCV_URL = '/cropper/opencv.js';
    ...
    this.startCamera = (resolution, callback, videoId) => {
        ...
        let video = document.getElementById(videoId) ? document.getElementById(videoId) : document.createElement('video');
        let videoConstraint = constraints[resolution] ? constraints[resolution] : true;
        ...
        navigator.mediaDevices.getUserMedia({video: videoConstraint, audio: false})
            ...
            .catch(err => self.printError('Camera Error: ' + err.name + ' ' + err.message));
    };
